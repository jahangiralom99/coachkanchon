    ...
    <div className="max-w-screen-lg mx-auto pt-24 pb-12 px-6">
      <div className="flex flex-col md:flex-row justify-center gap-12 items-center ">
        <div className="flex w-full items-center justify-center gap-6 bg-white rounded-md p-8 ">
          <h1 className="md:text-7xl text-4xl font-extrabold text-red-500">
            ফ্রি!
          </h1>
          <div className="space-y-2">
            <h2 className="md:text-5xl text-xl font-extrabold text-red-500">
              BUSINESS
            </h2>
      ...
      <div className="text-white relative h-[520px] md:h-[430px] bg-[#1c1c1c] max-w-screen-lg mx-auto md:space-y-5 p-10 border rounded-xl text-center mb-12">
        ...
        <h1 className="text-3xl font-bold text-red-500 md:text-white">
          FREE ONLINE SESSION
        </h1>
        <p className="font-semibold text-[#d0a065] md:text-white">
          18-20 JULY 2024
        </p>
        <p className="font-semibold text-[#d0a065] md:text-white">
          Time: 9PM - 11PM
